...
> **提示**：您还可以在 OpenVINO™ [深度学习工作台](https://docs.openvino.ai/latest/workbench_docs_Workbench_DG_Introduction.html)中使用模型优化器。该工作台是一个采用 GUI 的基于 Web 的工具，用于对深度学习模型的性能进行优化、调优、分析、可视化和比较。
...
> **注意**：在将 PyTorch 模型转换为 IR 之前，必须将其导出为 ONNX 格式。请参阅[转换 PyTorch 模型](prepare_model/convert_model/Convert_Model_From_PyTorch.md)了解更多信息。
